...
// ─── Supabase Config (env vars with fallback for dev) ───
const SB_URL = import.meta.env.VITE_SUPABASE_URL || "https://dqtjuissaqxkczddnkfk.supabase.co";
const SB_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRxdGp1aXNzYXF4a2N6ZGRua2ZrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQwOTczMDgsImV4cCI6MjA4OTY3MzMwOH0.kHOqp0qMO0nN0jlHMitf_jv5oAnmzLkzBE6gyHDX-J0";

// ─── Error Monitoring (Sentry) ───
const SENTRY_DSN = import.meta.env.VITE_SENTRY_DSN || "https://3cdfd5652417b5cabaddf0677781d77c@o4511092002324480.ingest.us.sentry.io/4511092012548096";
