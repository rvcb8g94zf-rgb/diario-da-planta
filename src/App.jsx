...
// ─── Public Profile ───
function PublicProfile({ targetUser, diaries, onBack, onViewDiary, lang, allBadges }) {
...
function AppInner() {
  ...
  const renderPage=()=>{
    if(publicProfile) return <PublicProfile targetUser={publicProfile.user} diaries={publicProfile.diaries} onBack={()=>setPublicProfile(null)} onViewDiary={d=>{setPublicProfile(null);setSelectedDiary(d);}} lang={lang} allBadges={allBadges}/>;
  ...
  if(pageContent) return (
    <div style={shellStyle}>
      ...
      <ImageViewer src={viewImage} onClose={()=>setViewImage(null)}/><VideoViewer src={viewVideo} onClose={()=>setViewVideo(null)}/>
