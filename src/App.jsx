            ...
            {featured && (
              <a href={featured.__post ? "#" : featured.url} target={featured.__post ? undefined : "_blank"} rel={featured.__post ? undefined : "noopener noreferrer"} onClick={featured.__post ? (e) => { e.preventDefault(); openPost(featured); } : undefined} style={{ position: "relative", borderRadius: "3px", overflow: "hidden", minHeight: isMobile ? "260px" : "340px", textDecoration: "none", display: "block" }}>
                ...
                <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "24px" }}>
                  ...
                  <h2 style={{ fontFamily: NP.serif, fontSize: isMobile ? "20px" : "26px", fontWeight: "700", color: NP.white, margin: "0 0 8px", lineHeight: "1.2", display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{featured.title}</h2>
                  {featured.summary && <p style={{ fontFamily: NP.serif, fontSize: "14px", color: "rgba(255,255,255,0.9)", margin: "0 0 8px", lineHeight: "1.45", maxWidth: "600px", display: "-webkit-box", WebkitLineClamp: isMobile ? 2 : 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{featured.summary}</p>}
