...
function AuthScreen({ onLogin }) {
  ...
  const doLogin=async()=>{
    ...
    try{
      ...
      onLogin({...profile,avatarImg:profile.avatar_url,authId:data.user.id});
  ...
  useEffect(()=>{(async()=>{
    ...
    try{
      ...
      if(authUser?.id){
        ...
        if(profile&&!profile.banned) setUser({...profile,avatarImg:profile.avatar_url,authId:authUser.id});
      }
    }catch{}
