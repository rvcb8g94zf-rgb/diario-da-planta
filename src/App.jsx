      ...
      {loading ? (
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "20px 16px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.7fr 1fr", gap: "16px", marginBottom: "8px" }}>
            {featured && (
              <a href={featured.url} target="_blank" rel="noopener noreferrer" style={{ position: "relative", borderRadius: "3px", overflow: "hidden", minHeight: isMobile ? "260px" : "340px", textDecoration: "none", display: "block" }}>
