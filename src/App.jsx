...
function BlogEditor({post,onSave,onClose,user}){
  ...
  const renderPreview=(text)=>{
    ...
    return text
      // YouTube embeds
      .replace(/\[youtube:([a-zA-Z0-9_-]{11})\]/g,'<div style="position:relative;padding-bottom:56.25%;height:0;margin:16px 0;border-radius:12px;overflow:hidden"><iframe src="https://www.youtube.com/embed/$1?cc_load_policy=1&rel=0" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none" allowfullscreen></iframe></div>')
      // Images
...
function BlogPostView({post,onBack,user,onEdit}){
  const renderMarkdown=(text)=>{
    ...
    return text
      // YouTube embeds
      .replace(/\[youtube:([a-zA-Z0-9_-]{11})\]/g,'<div style="position:relative;padding-bottom:56.25%;height:0;margin:20px 0;border-radius:12px;overflow:hidden"><iframe src="https://www.youtube.com/embed/$1?cc_load_policy=1&rel=0" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none" allowfullscreen></iframe></div>')
      // Images
