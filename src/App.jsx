...
function AppInner() {
  ...
  if(!inApp) return <><ThemeCSS dark={dark}/><NewsPortal loggedUser={user} onLogout={doLogout} onEnterApp={()=>{setInApp(true);try{history.replaceState(null,"","/");}catch{}}} dark={dark} onToggleDark={toggleDark}/></>;
