...
function NewsPortal({ onEnterApp, dark, onToggleDark, embedded = false, loggedUser = null, onLogout = null }) {
          ...
          <div ref={ref} style={{position:"relative"}}>
            ...
            {showMenu&&<div style={{position:"absolute",top:"46px",right:0,background:C.cardBg,borderRadius:"14px",border:`1px solid ${C.border}`,padding:"8px",minWidth:"240px",boxShadow:"0 8px 30px rgba(0,0,0,0.12)",zIndex:110}}>
              ...
              <div style={{borderTop:`1px solid ${C.border}`,marginTop:"6px",paddingTop:"6px"}}>
                {menuItem("📰","Voltar ao Portal",()=>{if(onBackToPortal){onBackToPortal();}else{nav("noticias");}})}
...
function AppInner() {
  ...
  const doLogin=u=>{setUser(u);setPage("home");setInApp(true);setShowAuth(false);trackEvent("login");};
  const doLogout=()=>{
  ...
  if(!inApp) return <><ThemeCSS dark={dark}/><NewsPortal loggedUser={user} onLogout={doLogout} onEnterApp={()=>setInApp(true)} dark={dark} onToggleDark={toggleDark}/></>;
